...
define i32 @func.quicksort(%struct.str* %s.ptr, i32 %left, i32 %right) {
    %left.ptr = alloca i32
...
lab.9:
    ...
    br label %lab.8
lab.10:
    %left.29 = load i32, i32* %left.ptr
    %j.30 = load i32, i32* %j.ptr
    %buffer31 = icmp sle i32 %left.29, %j.30
...
lab.18:
    ...
    %quicksort.57 = call i32 @func.quicksort(%struct.str* %s.54.ptr, i32 %left.55, i32 %j.56)
    br label %lab.20
lab.19:
    br label %lab.20
lab.20:
...
lab.21:
    ...
    %quicksort.64 = call i32 @func.quicksort(%struct.str* %s.61.ptr, i32 %i.62, i32 %right.63)
    br label %lab.23
lab.22:
    br label %lab.23
lab.23:
...
define i32 @main() {
    ...
    store i32 2, i32* %struct.str.0.68.ptr
    ...
    store i32 5, i32* %struct.str.0.74.ptr
    ...
    store i32 7, i32* %struct.str.0.76.ptr
    ...
    store i32 8, i32* %struct.str.0.80.ptr
    ...
    store i32 1, i32* %struct.str.0.82.ptr
    ...
    %buffer85 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.3, i32 0, i32 0 
...
lab.24:
    ...
    %buffer87 = icmp slt i32 %count.86, 9
...
lab.26:
    ...
    %quicksort.97 = call i32 @func.quicksort(%struct.str* %s.96.ptr, i32 0, i32 9)
...
lab.29:
    ...
    %buffer100 = icmp slt i32 %count.99, 9
...
@.str.3 = private unnamed_addr constant [7 x i8] c"Input\0A\00", align 1
